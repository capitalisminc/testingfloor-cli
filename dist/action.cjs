  ...
  "node_modules/readable-stream/lib/ours/errors.js"(exports2, module2) {
    ...
    E(
      ...
      (input2, name, value) => {
        ...
        return `Expected ${input2} to be returned from the "${name}" function but got ${type}.`;
      },
      TypeError
    );
    E(
...
function uploadFile(uploadUrl, uploadHeaders, filePath, size) {
  ...
  return new Promise((resolve, reject) => {
    ...
    (0, import_node_fs.createReadStream)(filePath).on("error", reject).pipe(request);
  });
}
